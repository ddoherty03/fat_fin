- [Installation](#org4e3ec5c)
- [Usage](#org9ac77cb)
  - [`CashPoint` class](#org94de381)
    - [Constructing a `CashPoint`  object](#orgb9667cc)
    - [Computing a `CashPoint`'s value on a different date with #value<sub>on</sub> (PV and FV)](#org56856c8)
    - [Computing the annualized growth rate between two `CashPoints` with #cagr (CAGR)](#orgb69659f)
  - [`CashFlow` class](#org1030274)
    - [Constructing `CashFlow` object](#orgbf2e4dc)
    - [Attributes of a `CashFlow`](#org26d8f10)
    - [Computing a `CashFlow`'s value on a different date with `#value_on` (NPV)](#orgb87acb3)
    - [Computing a `CashFlow`'s internal rate of return with `#irr` (IRR)](#org957c2d9)
    - [Computing a `CashFlow`'s a modified internal rate of Return with `#mirr` (MIRR aka MWIRR)](#orgf9d4053)
    - [Using Non-Standard Compounding](#orgbeefa30)
    - [Subsetting `CashFlow` with `#within(period)`](#orgcb2f81e)
- [Development](#org1eaf452)
- [Contributing](#orgd52f4a7)
- [License](#org21c9714)
...
The `CashPoint` class provides a `#cagr` method to measure the CAGR between two `CashPoints`. Recall that our `cp1` value is 25<sub>000.00</sub> on 2021-04-18. What CAGR would it represent if it had started out two years earlier as 15<sub>000</sub>, 17<sub>000</sub>, etc?

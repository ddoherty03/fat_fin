...
#+begin_src ruby :session readme
  tv1 = FatFin::CashPoint.new(25_000.00, date: '2021-04-18')
#+end_src
...
two ~CashPoints~.  Recall that our ~tv1~ value is 25_000.00 on 2021-04-18.
...
#+begin_src ruby
  ...
  (15_000..30_000).step(2_000) do |val0|
    tv0 = FatFin::CashPoint.new(val0, date: tv1.date - 2.years)

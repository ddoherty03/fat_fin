...
#+PROPERTY: header-args:ruby+ :wrap example :session fat_fin_session :eval yes
#+PROPERTY: header-args:ruby+ :prologue "$:.unshift('./lib') unless $:.first == './lib'; require 'fat_fin'"
...
- [[#usage][Usage]]
  ...
  - [[#cashflow-class][~CashFlow~ class]]
    ...
    - [[#attributes-of-a-cashflow][Attributes of a ~CashFlow~]]
      ...
      - [[#extracting-the-dates-amount-and-cashpoints][Extracting the Dates, Amount, and CashPoints]]
...
**** Extracting the Dates, Amount, and CashPoints

...
#+begin_src ruby :results output
  dev_lib = File.expand_path('./lib')
  $:.unshift(dev_lib) unless $:.include?(dev_lib)
  dev_bin = File.expand_path('./bundle/bin')
  ENV['PATH'] = ENV['PATH'].split(':').unshift(dev_bin).join(':') unless ENV['PATH'].split(':').include?(dev_bin)
...
#+begin_example
#<FatFin::CashPoint:0x00007e2e3a13d918 @amount=25000.0, @date=Sun, 18 Apr 2021>
#+end_example

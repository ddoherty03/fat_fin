...
#+begin_src ruby :results output
  ...
  $:[0..10].each { |d| puts d }
  puts "..."
  require_relative 'lib/fat_fin'  # => true
#+end_src

#+RESULTS:
#+begin_example
LoadError: cannot load such file -- fat_fin (LoadError)
from <internal:/home/ded/.rbenv/versions/3.4.1/lib/ruby/site_ruby/3.4.0/rubygems/core_ext/kernel_require.rb>:136:in 'Kernel#require'
Current directory: /home/ded/src/fat_fin
=> nil
Ruby LOADPATH:
=> nil
=> ["./lib",
 "/home/ded/.rbenv/rbenv.d/exec/gem-rehash",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/coderay-1.1.3/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/pry-0.15.2/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/set-1.1.2/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/method_source-1.1.0/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/forwardable-1.3.3/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/etc-1.4.6/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/extensions/x86_64-linux/3.4.0/etc-1.4.6",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/prettyprint-0.2.0/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/pp-0.6.3/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/stringio-3.1.9/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/extensions/x86_64-linux/3.4.0/stringio-3.1.9",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/strscan-3.1.5/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/extensions/x86_64-linux/3.4.0/strscan-3.1.5",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/prism-1.6.0/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/extensions/x86_64-linux/3.4.0/prism-1.6.0",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/gems/io-console-0.8.1/lib",
 "/home/ded/.rbenv/versions/3.4.1/lib/ruby/gems/3.4.0/extensions/x86_64-linux/3.4.0/io-console-0.8.1",
...
- [[#usage][Usage]]
  ...
  - [[#cashflow-class][~CashFlow~ class]]
    ...
    - [[#attributes-of-a-cashflow][Attributes of a ~CashFlow~]]
      - [[#first-and-last-dates][First and Last Dates]]
      - [[#years-between-first-and-last][Years Between First and Last]]
      - [[#number-of-cashpoints][Number of CashPoints]]
      - [[#extracting-the-dates-values-and-cashpoints][Extracting the Dates, Values and CashPoints]]
...
I used the ~#commas~ method from my ~fat_core~ gem to make the numbers more
readable.
...
sometimes we want to analyze a whole sequence of ~CashPoints~, and this is what
...
with an ~add_cash_point~ method or its equivalent, the ~<<~ shovel operator.
...
Once constructed, you can query for certain attributes of a ~CashFlow~ object.
For one, you can get its first and last date:
...
Using the ~#years~ method, you can get the number of years between the first
and last ~CashPoint~ in the ~CashFlow~.  The number of years is expressed as a
floating point number computed as the number of days between the first and
last ~CashPoint~s divided by 365.25
...
**** Extracting the Dates, Values and CashPoints
...
receipts are represented by positive numbers.

We can calculate the NPV of the above stream by applying the ~value_on~ for
the first date to the ~CashFlow~ object:
...
It returns a new CashFlow that narrows this CashFlow to the given period.  All

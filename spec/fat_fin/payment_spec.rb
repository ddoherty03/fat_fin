...
module FatFin
  describe Payment do
    ...
    let(:fut_pmt) { Payment.new(55_102.9895856, date: "2025-01-01") }
    let(:eps) { 0.00001 }

    it "initializes a Payment" do
      expect(pmt.amount).to eq(45_000.33)
    ...
    it "computes simple interest with frequency 0" do
      ...
      # 54562.900125
      expect(pmt.value_on("2025-01-01", rate: 0.10, freq: 0)).to be_within(eps).of(54_562.900125)
    end
    ...
    it "computes future value at any date with default frequency 1" do
      ...
      # 55102.9886501
      expect(pmt.value_on("2025-01-01", rate: 0.10)).to be_within(eps).of(55_102.9886501)
    end
    ...
    it "computes future value at any date with frequency 2" do
      ...
      expect(pmt.value_on("2025-01-01", rate: 0.10, freq: 2)).to be_within(eps).of(55_369.4512848)
    end
    ...
    it "computes future value at any date with frequency 3" do
      ...
      expect(pmt.value_on("2025-01-01", rate: 0.10, freq: 3)).to be_within(eps).of(55_462.3794719)
    end
    ...
    it "computes future value at any date with frequency 4" do
      ...
      # = 55509.6583625
      expect(pmt.value_on("2025-01-01", rate: 0.10, freq: 4)).to be_within(eps).of(55_509.6583625)
    end
    ...
    it "computes future value at any date with frequency 6" do
      ...
      expect(pmt.value_on("2025-01-01", rate: 0.10, freq: 6)).to be_within(eps).of(55_557.494589)
    end
    ...
    it "computes past value at any date with default frequency 1" do
      ...
      # 45000.330764
      expect(fut_pmt.value_on("2022-11-16", rate: 0.10)).to be_within(eps).of(45_000.330764)
    end
